...
- [Combining multiple crates](combining-multiple-crates.md) — Load several crates at once, join them through shared language metadata, then compare their place footprints
...
- **PARADISEC collections related to South Efate, Vanuatu — NT1, NT8, BR1** (combining-crates tutorial). Metadata only. Access conditions as declared by PARADISEC. Source: [PARADISEC catalogue](https://catalog.paradisec.org.au/) (collections [NT1](https://catalog.paradisec.org.au/collection?id=https%3A%2F%2Fcatalog.paradisec.org.au%2Frepository%2FNT1), [NT8](https://catalog.paradisec.org.au/collection?id=https%3A%2F%2Fcatalog.paradisec.org.au%2Frepository%2FNT8), [BR1](https://catalog.paradisec.org.au/collection?id=https%3A%2F%2Fcatalog.paradisec.org.au%2Frepository%2FBR1)).
